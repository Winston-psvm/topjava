...
public abstract class AbstractJdbcMealRepository<T> implements MealRepository {
    ...
    public abstract T timeConvector(LocalDateTime localDateTime);
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", timeConvector(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, timeConvector(startDateTime), timeConvector(endDateTime));
    }
}
