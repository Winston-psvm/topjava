...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetween() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter?startDateTime=2020-01-30T19:00&endDateTime=2020-01-31T21:00:00"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(MATCHER_TO.contentJson(createTo(meal7, true), createTo(meal3, false)));
    }
}
